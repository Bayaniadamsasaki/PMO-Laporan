...
class EditLaporanKebakaran extends StatefulWidget {
  final KebakaranResponseModel item;

  const EditLaporanKebakaran({Key? key, required this.item}) : super(key: key);

  @override
  State<EditLaporanKebakaran> createState() => _EditLaporanKebakaranState();
}

class _EditLaporanKebakaranState extends State<EditLaporanKebakaran> {
