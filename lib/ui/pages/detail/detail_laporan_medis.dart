...
class DetailLaporanMedis extends StatelessWidget {
  final MedisResponseModel laporan;

  const DetailLaporanMedis({Key? key, required this.laporan}) : super(key: key);
  ...
  Widget _buildFotoWidget() {
    if (laporan.foto != null) {
      ...
      return const SizedBox
          .shrink(); // jika tidak ada foto, tampilkan widget kosong
    }
  }
}
